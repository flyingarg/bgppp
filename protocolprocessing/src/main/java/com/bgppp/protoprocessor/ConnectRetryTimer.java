...
public class ConnectRetryTimer extends Thread{
	public static Logger log = Logger.getLogger(ConnectRetryTimer.class.getName());
	boolean isRunning = true;
	Long counter = null;
	TimerListener timerListener = null;
	String linkBetween = "";

	public ConnectRetryTimer(String linkBetween, Long counter, TimerListener timerListener){
