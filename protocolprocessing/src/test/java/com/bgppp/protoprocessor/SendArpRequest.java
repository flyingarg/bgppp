...
public class SendArpRequest {
  ...
  public static void main(String[] args) throws PcapNativeException, NotOpenException {
    String strSrcIpAddress = "192.168.1.109"; // for InetAddress.getByName()
    String strDstIpAddress = "192.168.1.1";//args[0]; // for InetAddress.getByName()
    ...
    try {
      nif = Pcaps.getDevByName("eth0");//new NifSelector().selectNetworkInterface();
    } catch (Exception e) {
      e.printStackTrace();
      return;
    }
